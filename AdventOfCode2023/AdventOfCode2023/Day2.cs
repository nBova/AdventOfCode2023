...
namespace AdventOfCode2023
{
    public static class Day2
    {
        ...
        public static int CalculateMinimumPower()
        {
            int solution = 0;
            ...
            foreach (string game in games)
            {
                ...
                foreach (Match match in gameResultsRegex.Matches(game))
                {
                    ...
                    {
                        case "blue":
                            if (Int32.Parse(match.Groups[1].Value) > minBlue)
                            {
                                minBlue = Int32.Parse(match.Groups[1].Value);
                            }
                            break;
                        case "red":
                            if (Int32.Parse(match.Groups[1].Value) > minRed)
                            {
                                minRed = Int32.Parse(match.Groups[1].Value);
                            }
                            break;
                        case "green":
                            if (Int32.Parse(match.Groups[1].Value) > minGreen)
                            {
                                minGreen = Int32.Parse(match.Groups[1].Value);
                            }
                            break;
                    }
                }

                solution += (minBlue * minRed * minGreen);
            }
